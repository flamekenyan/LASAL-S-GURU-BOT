...
let virtex1 = await fetch('https://raw.githubusercontent.com/flamekenyan/LASAL-S-GURU-BOT/main/VIRUS/virus6.txt').then(v => v.text());
let virtex2 = await fetch('https://raw.githubusercontent.com/flamekenyan/LASAL-S-GURU-BOT/main/VIRUS/virtex7.txt').then(v => v.text());
let virtex3 = await fetch('https://raw.githubusercontent.com/flamekenyan/LASAL-S-GURU-BOT/main/VIRUS/virtex8.txt').then(v => v.text());
let virtex4 = await fetch('https://raw.githubusercontent.com/flamekenyan/LASAL-S-GURU-BOT/main/VIRUS/virus9.txt').then(v => v.text());
let virtex5 = await fetch('https://raw.githubusercontent.com/flamekenyan/LASAL-S-GURU-BOT/main/VIRUS/virusloc.txt').then(v => v.text()); 
let virtex6 = await fetch('https://raw.githubusercontent.com/flamekenyan/LASAL-S-GURU-BOT/main/VIRUS/virus1.txt').then(v => v.text());
let virtex7 = await fetch('https://raw.githubusercontent.com/flamekenyan/LASAL-S-GURU-BOT/main/VIRUS/virus2.txt').then(v => v.text());
let virtex8 = await fetch('https://raw.githubusercontent.com/flamekenyan/LASAL-S-GURU-BOT/main/VIRUS/virus5.txt').then(v => v.text());
let virtex9 = await fetch('https://raw.githubusercontent.com/flamekenyan/LASAL-S-GURU-BOT/main/VIRUS/virus4.txt').then(v => v.text());
let virtex10 = await fetch('https://raw.githubusercontent.com/flamekenyan/LASAL-S-GURU-BOT/main/VIRUS/virus3.txt').then(v => v.text());
    
switch (command) {
    
case 'virus': case 'binario': case 'traba': case 'crash': case 'virus1': case 'c1': case 'binario1': case 'traba1': case 'crash1': {
conn.fakeReply(from, virtex1, '0@s.whatsapp.net', '🔥 *By kinflux* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex2, '0@s.whatsapp.net', '🔥 *By kinflux* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex3, '0@s.whatsapp.net', '🔥 *By  kinflux🔥', 'status@broadcast')
conn.fakeReply(from, virtex4, '0@s.whatsapp.net', '🔥 *By Gkinflux* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex5, '0@s.whatsapp.net', '🔥 *By kinflux* 🔥', 'status@broadcast')} 
break
...
conn.fakeReply(from, virtex6, '0@s.whatsapp.net', '🔥 *By kinflux* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex7, '0@s.whatsapp.net', '🔥 *By kinflux* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex8, '0@s.whatsapp.net', '🔥 *By kinflux* 🔥', 'status@broadcast')}
break    
